...
function remove_bloat($page)
{
	...
	$page = str_replace("https://thepiratebay.se", "http://thepiratebay.asia", $page);
	$page = str_replace("http://thepiratebay.se", "http://thepiratebay.asia", $page);
	$page = str_replace("http://thepiratebay.org", "http://thepiratebay.asia", $page);
	$page = str_replace("https://thepiratebay.org", "http://thepiratebay.asia", $page);
	//Proxy the images
